defmodule Tasktracka.Tracker do
  @moduledoc """
  The Tracker context.
  """
  ...
  def list_tasks_by_manager_id(user_id) do
    query = from m in Manage, where: m.manager_id == ^user_id,
      join: t in Task, on: m.managee_id==t.user_id,
      select: t
    Repo.all(query)
    |> Repo.preload(:user)
  end
